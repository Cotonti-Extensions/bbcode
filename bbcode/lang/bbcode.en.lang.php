...
<ul><li><strong>Name</strong> - BBcode name (use alphanumerics and underscores only)</li>
<li><strong>Mode</strong> - Parsing mode, on of the following: 'str' (str_replace), 'pcre' (preg_replace) and 'callback' (preg_replace_callback)</li>
